...
class Temporal_feature_EEG(nn.Module):
    def __init__(self):
        ...
        self.features1 = nn.Sequential(
            nn.Conv1d(6, 64, kernel_size=64, stride=8, bias=False, padding=24),
            nn.BatchNorm1d(64),
            nn.LeakyReLU(),
        ...
        self.features2 = nn.Sequential(
            nn.Conv1d(6, 64, kernel_size=512, stride=64, bias=False, padding=24),
            nn.BatchNorm1d(64),
            nn.LeakyReLU(),
...
class SleepPrintNet_isruc(BasicModel):
    def __init__(self):
        super(SleepPrintNet_isruc, self).__init__()
