...
class MMASleepNet_eegeogemg_MBFE_TRANS(BasicModel):
    def __init__(self,cfg):#,d_model,afr_reduced_cnn_size):
        super(MMASleepNet_eegeogemg_MBFE_TRANS, self).__init__()
    ...
    def forward(self, x1,x2,x3):
        ...
        encoded_features=self.transformer_encoder(x_cat.view(self.batch_size,-1,96) )
        encoded_features=encoded_features.contiguous().view(self.batch_size, -1)
