...
class LayerNorm(nn.Module):
    ...
    def forward(self, x):
        ...
        # print('self.a_2.shape,self.b_2.shape:',self.a_2.shape,self.b_2.shape)
...
class SublayerOutput(nn.Module):
    ...
    def forward(self, x, sublayer):
        ...
        # print('x.shape,self.dropout(sublayer(self.norm(x))).shape:',x.shape,self.dropout(sublayer(self.norm(x))).shape)
...
class AttnSleep_isruc(BasicModel):
    def __init__(self):
        super(AttnSleep_isruc, self).__init__()
