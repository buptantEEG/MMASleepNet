...
class Config():
    def __init__(self,  
        ...
        self.output_dir = f'ckpt/SleepPrintNet/sleepedf-{self.subjects_num}/fold{self.fold_id}_subject{self.subject}/{self.model.init_time}'

def main(fold_id,chs,subjects_num):
    print(f"------------------------------------FOLD_{fold_id}------------------------------------")
    cfg = Config(fold_id=fold_id,subject=subjects[fold_id],SS=12,subjects_num=subjects_num)
...
if __name__ == '__main__':
    ...
    print('args2.np_data_dir',args2.np_data_dir)
