...
class Config():
    def __init__(self,  
        ...
        self.epochs = 150
        # Model
        self.model=model.MMASleepNet_eegeogemg_plus_MBFE(self).to(device)
        ...
        self.output_dir = f'ckpt/MMASleep-Ablation1/MBFE/sleepedf-{self.subjects_num}/fold{self.fold_id}_subject{self.subject}/{self.model.init_time}'
